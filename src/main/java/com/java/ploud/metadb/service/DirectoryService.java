...
public class DirectoryService {
    ...
    public Directory findLastParent(String originalFilename, String ownerId) {
        ...
        Directory root = createRoot(ownerId);
    ...
    public Directory createRoot(String ownerId) {
        Directory byDirName = directoryRepository.findByDirNameAndParentIsNull(ownerId)
                .orElseGet(() -> directoryRepository.saveAndFlush(
                Directory.builder()
                        .dirName("")
                        .ownerId(ownerId)
                        .parent(null)
